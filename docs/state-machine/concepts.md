...
Implement [`Command`](https://github.com/rasuvaeff/property-testing/blob/master/src/StateMachine/Command.php) — four pure-ish
...
[`PostconditionViolation`](https://github.com/rasuvaeff/property-testing/blob/master/src/StateMachine/PostconditionViolation.php) naming
the step:
...
See [`examples/state_machine.php`](https://github.com/rasuvaeff/property-testing/blob/master/examples/state_machine.php) for the full stack
example.
