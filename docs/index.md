...
description: "Property-based testing for PHP 8.3+, a Testo plugin: generate hundreds of random inputs, find the one that falsifies your property, and shrink it to a minimal counterexample."
hero:
  ...
  actions:
    - theme: brand
      ...
      link: /intro/what-is-property-testing
    - theme: alt
...
features:
  ...
  - title: Deadlines, not just assertions
    ...
    link: /controlling-runs/deadlines
...
see the [Examples](/examples) page for what each one shows.
