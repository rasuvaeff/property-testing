...
[`ArbitraryInterface`](https://github.com/rasuvaeff/property-testing/blob/master/src/ArbitraryInterface.php) directly: `generate(Random)`
returns a [`Shrinkable`](https://github.com/rasuvaeff/property-testing/blob/master/src/Shrinkable.php) — the drawn value plus a lazy tree
