...
[Bounding shrink work](/controlling-runs/bounding-shrink).
...
[custom `ArbitraryInterface`](/generators/custom-arbitrary) you write),
make that guarantee:
...
[Custom arbitrary](/generators/custom-arbitrary).
