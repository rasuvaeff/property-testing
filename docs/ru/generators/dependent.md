...
description: "Построение одного сгенерированного значения из другого через Gen::flatMap() и in-body зависимые draw через Gen::draw() для нескольких зависимых значений сразу."
---
