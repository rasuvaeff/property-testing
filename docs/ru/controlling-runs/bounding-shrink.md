...
description: "Ограничение того, сколько времени shrinker ищет минимальный контрпример, чтобы патологический падающий вход не превратил прогон property в зависание."
---
