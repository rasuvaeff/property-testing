---
title: "Безопасность"
description: "На чём безопасно запускать property-testing: без eval, без сети, без записи на диск вне PROPERTY_DB — и что остаётся ответственностью автора теста."
---
