...
description: "Dialing runs up for CI without editing test code, keeping the regression corpus out of version control, and bounding pathological input runtime."
---
...
`PROPERTY_DB=<dir>` turns on the [regression corpus](/regression-corpus):
...
[Deadlines and time budgets](/controlling-runs/deadlines) for the
