...
final class ValueCodecTest
{
     ...
     * form {@see \Rasuvaeff\PropertyTesting\Internal\CorpusStorage} stores.
     */
    #[Property(runs: 200, seed: 20260730)]
    public function encodedValuesSurviveJsonTransport(mixed $value): void
    {
        Assert::same($this->transport($value), $value);
    }

    /** @return array<string, ArbitraryInterface> */
    public static function encodedValuesSurviveJsonTransportGenerators(): array
    {
        ...
        return ['value' => Gen::json(3)];
    }

    #[Property(runs: 100, seed: 20260731)]
    public function encodedByteStringsSurviveJsonTransport(string $value): void
    {
        Assert::same($this->transport($value), $value);
    }

    /** @return array<string, ArbitraryInterface> */
    public static function encodedByteStringsSurviveJsonTransportGenerators(): array
    {
        return ['value' => Gen::bytes(0, 12)];
    }
