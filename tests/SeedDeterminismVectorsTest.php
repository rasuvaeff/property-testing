 ...
 * observable definition of `CorpusStorage::SEQUENCE_EPOCH` — they move to
...
final class SeedDeterminismVectorsTest
{
    ...
    {
        yield 'int' => [
            static fn(): ArbitraryInterface => Gen::int(),
            101,
        ...
        yield 'intPositive' => [
            static fn(): ArbitraryInterface => Gen::intPositive(),
            103,
            [9223372036854775807, 3153354516774608220, 7289708339898856691, 1, 9223372036854775807],
        ];

        yield 'float' => [
            static fn(): ArbitraryInterface => Gen::float(),
            104,
        ...
        yield 'bool' => [
            static fn(): ArbitraryInterface => Gen::bool(),
            106,
            [false, false, true, true, true],
        ];

        yield 'string (unicode, hex-normalised)' => [
            static fn(): ArbitraryInterface => Gen::string(),
            107,
            [
        ...
        yield 'stringAscii' => [
            static fn(): ArbitraryInterface => Gen::stringAscii(),
            108,
            [
        ...
        yield 'uuid' => [
            static fn(): ArbitraryInterface => Gen::uuid(),
            120,
            [
        ...
        yield 'ipv4' => [
            static fn(): ArbitraryInterface => Gen::ipv4(),
            122,
            ['154.182.62.108', '187.207.182.21', '169.78.228.51', '141.173.1.188', '255.42.48.255'],
        ];

        yield 'email' => [
            static fn(): ArbitraryInterface => Gen::email(),
            123,
            [
        ...
        yield 'url' => [
            static fn(): ArbitraryInterface => Gen::url(),
            124,
            [
